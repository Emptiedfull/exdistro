...
type Payload struct {
	...
	Trusted       [][]byte               `protobuf:"bytes,2,rep,name=trusted,proto3" json:"trusted,omitempty"`
...
func (x *Payload) GetPrivKey() []byte {
	if x != nil {
		return x.PrivKey
	}
	return nil
...
func (x *Payload) GetTrusted() [][]byte {
	if x != nil {
		return x.Trusted
	}
	return nil
...
var file_payload_proto_rawDesc = []byte{
	...
	0x3d, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x72,
	0x69, 0x76, 0x4b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x70, 0x72, 0x69,
	0x76, 0x4b, 0x65, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x74, 0x72, 0x75, 0x73, 0x74, 0x65, 0x64, 0x18,
	0x02, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x07, 0x74, 0x72, 0x75, 0x73, 0x74, 0x65, 0x64, 0x42, 0x06,
